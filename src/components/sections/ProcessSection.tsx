  ...
  return (
    <section className={cn('bg-white/[0.015] py-20 sm:py-24 lg:py-28', className)}>
      <Container>
        ...
        <div className="mt-10 grid gap-5 overflow-x-auto pb-2 md:grid-cols-2 lg:grid-cols-5 lg:overflow-visible">
          {steps.map((step, index) => (
            <Reveal key={step.number} direction="up" delay={index * 0.08}>
              <article className="h-full rounded-[1.5rem] border border-[var(--border)] bg-[linear-gradient(180deg,rgba(245,240,232,0.04),rgba(245,240,232,0.015))] p-5" data-card>
