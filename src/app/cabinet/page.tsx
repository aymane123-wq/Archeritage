...
export default function CabinetPage() { return <>
  ...
  <section className="section section--ink"><Container className="founder-grid"><div className="founder-image"><Image src="/images/cabinet/cabinet-architecture-institutionnelle.jpg" alt="Architecture institutionnelle, visuel temporaire dans l’attente du portrait validé du fondateur" fill sizes="(min-width: 1024px) 42vw, 100vw" /></div><div><p className="eyebrow">Le fondateur</p><h2>Ahmed Taoufik Naciri, architecte</h2><p>{cabinet.founder}</p></div></Container></section>
